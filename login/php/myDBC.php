...
class myDBC {
	...
	public function logueo($usuario, $contrasenia){
		...
		$q = "select * from login where nombre='$usuario' and password='$pass_c'";
	...
	public function agregaUsuario($nombre, $apellidos, $mail, $contras){
		...
		$nuevo_correo = "select correo from login where correo='$mail'";
		...
		{
			//Inserta en la BD 
			$q = "INSERT INTO login (login_nombre, login_apellidos, login_correo, login_password) VALUES ('$nombre','$apellidos', '$mail', '$contras'); ";
