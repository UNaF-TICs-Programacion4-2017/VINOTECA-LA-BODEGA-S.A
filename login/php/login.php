  ...
  <body>
    ...
    if (isset($_GET["estado"])) {
        ...
        if($estado == "incorrecto"){
            echo "<center><strong style='color:red;'>EL USUARIO ES INCORRECTO, INTENTE NUEVAMENTE</strong></center>";
        }else if($estado == "finalizada"){
            echo "<center><strong style='color:green;'>HAZ CERRADO LA SESSION CORRECTAMENTE</strong></center>";
        }
     ...
     ?>
      <form class="form-signin" method="POST" action="login_procesar.php">
        ...
        <input type="email" id="inputEmail" class="form-control" placeholder="Correo Electrónico"  autofocus name="email">
