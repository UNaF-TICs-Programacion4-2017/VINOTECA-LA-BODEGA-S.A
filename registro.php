...
<head>
 ...
 <title>Registro | Vinoteca La Bodega S.A</title>
...
<form action = "agregar.php" method="POST" >
 <p> Apellido y Nombre: <input type="text" name="login_nombre" /></p>
 <p> Correo: <input type="text"  name="login_email" /></p>
  <p> Contraseña: <input type="password"  name="login_pas" /></p>
   <p> Repetir Contraseña: <input type="password" name="login_rpas" /></p>
	...
	<footer>
		<div class="servicios">
			<div class="row">
				...
				<div class="col-sm-3">
					<h1>Preguntas</h1>
					<p><a href="contacto.php" id="contacto">Escribinos, estamos <br> para ayudarte.</a></p>
				</div>
			</div>
		</div>
		<div class="links">
