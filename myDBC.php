...
class myDBC {
	...
	public function logueo($usuario, $contrasenia){
		...
		$q = "select * from login where login_nombre='$usuario' and login_pas='$pass_c'";
	...
	public function agregaUsuario($nombre, $apellidos, $mail, $contras){
		...
		$nuevo_correo = "select login_mail from login where login_mail='$mail'";
		...
		{
			//Inserta en la BD 
			$q = "INSERT INTO login (login_nombre, login_email, login_pas, login_rpas) VALUES ('$nombre','$mail', '$contras', '$repass'); ";
